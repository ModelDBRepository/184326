'''
Current clamp demo using Allen Brain's model 473862421.
...
from neuron473862421 import Neuron473862421
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473862421(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473862421; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-88.2336349487)
        h.fcurrent()
